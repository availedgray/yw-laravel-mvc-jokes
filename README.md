...
The Laravel jokes mvc project is part of the deliverable of SaaS unit, portfolio assessment pt3, demonstrating development of the application using a PHP Framework, Laravel.
...
[![PhpStorm][jetbrains.com/phpstorm/]][PhpStorm-url]
...
| MVC    | Stands for Model-View-Controller. A design pattern for organizing code in three layers: Model (data), View (user interface), and Controller (logic) |
| Spatie | A package providing tools for tasks like permissions is used in this project                                                                        |
